...
public class HelloAccount02 {
    ...
    public static void main(String[] args) {
        SavingAccount sa =
                new SavingAccount(101, "Charles", 100.0, Level.VIP);
        CreditAccount ca =
                new CreditAccount(102, "Elsa", 150.0, 200);
